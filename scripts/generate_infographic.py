...
Generates a single infographic image using the Google Gemini API.

Usage:
    python scripts/generate_infographic.py \
        --prompt "A standalone infographic in cool neumorphic design style..." \
...
def generate(prompt: str, output_path: str, aspect_ratio: str = "1:1") -> str:
    ...
    # Attempt 1: Gemini 2.5 Flash Image (native image gen)
    try:
